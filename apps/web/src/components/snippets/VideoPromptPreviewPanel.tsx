...
export const VideoPromptPreviewPanel = ({
  ...
  useEffect(() => {
    if (activeSnippet) {
      updateCombinedPrompt(activeSnippet.textField1 || '');
    }
  }, [activeSnippet?.textField1, updateCombinedPrompt]);
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${modelSettings.audio ? 'bg-purple-600' : 'bg-gray-400'
                  }`}
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${modelSettings.audio ? 'translate-x-6' : 'translate-x-1'
                    }`}
                />
              </button>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${modelSettings.offPeak ? 'bg-purple-600' : 'bg-gray-400'
                  }`}
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${modelSettings.offPeak ? 'translate-x-6' : 'translate-x-1'
                    }`}
                />
              </button>
            </div>
